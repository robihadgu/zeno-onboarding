  ...
  return (
    <form onSubmit={handleSubmit} className="glass-card p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div>
          <label className="block text-[12px] font-medium mb-2 uppercase tracking-[0.08em]" style={{ color: "var(--gray-400)" }}>
            Client Name
          </label>
          <input
            type="text"
      ...
      {success && (
        <div
          className="mt-5 px-4 py-3 rounded-xl text-[13px] flex items-center gap-2"
          style={{ background: "rgba(255,255,255,0.05)", color: "var(--white)", border: "1px solid var(--border)" }}
        >
          <span>&#10003;</span> {success}
        </div>
      )}
